...
Note that [submitter processed](#submitter-processed-submitter-processed-badge) samples that are available through the web user interface are omitted from normalized compendia because [these samples can introduce unwanted technical variation](https://github.com/AlexsLemonade/refinebio/issues/2114).
